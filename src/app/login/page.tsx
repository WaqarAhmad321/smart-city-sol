...
export default function LoginPage() {
  const { signInWithEmailPassword, signInWithGoogle, loading } = useAuth();
  ...
  const handleFirebaseAuthError = (error: FirebaseError) => {
    switch (error.code) {
      ...
      case "auth/too-many-requests":
        setAuthError("Access to this account has been temporarily disabled due to many failed login attempts. You can immediately restore it by resetting your password or you can try again later.");
        break;
      case "auth/popup-closed-by-user":
        setAuthError("Google Sign-In was cancelled.");
        break;
      case "auth/popup-blocked":
        setAuthError("Google Sign-In popup was blocked by the browser. Please disable your popup blocker and try again.");
        break;
      default:
  ...
  const CitySyncLogoSmall = () => (
    <div className="flex items-center justify-center gap-2 mb-6">
      ...
      <span className="font-bold text-xl font-headline text-foreground">CitySync</span>
    </div>
  );
    ...
    <div className="w-full flex h-screen items-center justify-center">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Sign in to access your CitySync dashboard.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
